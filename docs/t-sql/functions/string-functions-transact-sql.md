...
|[UPPER](../../t-sql/functions/upper-transact-sql.md) | | |
 ...
 文字列関数に文字列値以外の引数を渡すと、暗黙的に入力型が text データ型に変換されます。 詳細については、[データ型の変換 &#40;Database Engine&#41;](../../t-sql/data-types/data-type-conversion-database-engine.md) を参照してください。  

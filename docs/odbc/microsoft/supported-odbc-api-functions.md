...
|ODBC 関数|Access<br/>ドライバー<br/>固有の<br/>注意事項|dBASE<br/>ドライバー<br/>固有の<br/>注意事項|Paradox<br/>ドライバー<br/>固有の<br/>注意事項|テキスト<br/>ファイル<br/>ドライバー<br/>固有の<br/>注意事項|Excel<br/>ドライバー<br/>固有の<br/>注意事項|すべての<br/>ドライバーに<br/>関連する<br/>注意事項|  
|-------------------|-----------------------------------|----------------------------------|------------------------------------|--------------------------------------|----------------------------------|-----------------------------------|  

...
2.  次の行を追加して、 [ADO を使用して sqlxml 4.0 クエリを実行](../../../relational-databases/sqlxml/using-ado-to-execute-sqlxml-4-0-queries.md) し、アップデートグラムを実行するために sqlxml 4.0 テストスクリプト (Sqlxml4test.vbs) を準備し `cmd.Properties("Output Stream").Value = outStream` ます。  

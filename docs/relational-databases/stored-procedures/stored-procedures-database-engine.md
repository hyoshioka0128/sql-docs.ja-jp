...
description: SQL Server のストアド プロシージャが 1 つ以上の Transact-SQL ステートメントのグループ、または .NET Framework 共通言語ランタイム メソッドの参照になるしくみについて説明します。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql

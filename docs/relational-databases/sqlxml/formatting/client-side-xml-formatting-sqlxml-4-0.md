...
description: FOR XML 句を使用して、SQLXML 4.0 でのクライアント側の XML 書式設定について説明します。
ms.date: 03/16/2017
ms.prod: sql

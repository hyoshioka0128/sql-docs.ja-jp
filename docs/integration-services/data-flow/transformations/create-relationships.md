 ...
 **リレーションシップの作成** ダイアログ ボックスを使用した変換の詳細については、「[あいまい参照変換](../../../integration-services/data-flow/transformations/fuzzy-lookup-transformation.md)」、「[参照変換](../../../integration-services/data-flow/transformations/lookup-transformation.md)」、および「[用語参照変換](../../../integration-services/data-flow/transformations/term-lookup-transformation.md)」を参照してください。  
